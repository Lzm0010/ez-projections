...
//seed data
const {populateUsers, populateCompanies, populateCategories, populateRules, populateProducts, populateAssumptions} = require('./seed/seed');
...
beforeEach(populateAssumptions);
